(function() {
    ...
    let totalPrice = 0;
      ...
      for (let i = 0; i < orders_now.length; i++) {
        ...
        let order_single_bookName = document.createElement('div');
        ...
        order_single_bookName.setAttribute("class", "order_" + i);
